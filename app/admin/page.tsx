...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    setStudents(getData("students", initialStudents));
    setTestimonials(getData("testimonials", initialTestimonials));
    setComments(getData("comments", initialComments));
    setNews(getData("news", initialNews));
    setMounted(true);
  }, []);
